                ...
                <div class="col-md">
                    <section class="section register inner-left-xs">
                        ...
                        <ul class="list-unstyled list-benefits">
                            <li><i class="fa fa-check primary-color"></i> Купить квесты, которые предствалены в каталоге</li>
                            <li><i class="fa fa-check primary-color"></i> Заказать свой собственный квест</li>
                            <li><i class="fa fa-check primary-color"></i> Сделать подарок любимым(Праздничный квест)</li>
                        </ul>
