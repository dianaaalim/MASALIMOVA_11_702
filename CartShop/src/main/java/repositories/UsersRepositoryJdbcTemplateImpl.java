...
public class UsersRepositoryJdbcTemplateImpl implements UsersRepository{
    ...
    private static final String SQL_INSERT_USER =
            "insert into users(name, email, phone, hashpassword) values (?, ?, ?, ?)";
    ...
    public void save(User model) {
        jdbcTemplate.update(SQL_INSERT_USER, model.getName(), model.getEmail(), model.getPhone(), model.getHashPassword());
    }
